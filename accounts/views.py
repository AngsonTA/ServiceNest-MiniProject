...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send()
            # messages.success(request, 'Thank you for registering with us. we have sent a verification mail to respeictive email address please click on the link')
        ...
        if user is not None:
            try:
                ...
                for item in cart_item:
                        ...
                        # getting the cart items from the user to access the product variation
            ...
            try:
                ...
                # print('query ->', query)
                # next = /cart/checkout/ so we need to take queery and split equals part
